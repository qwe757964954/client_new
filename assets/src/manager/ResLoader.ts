...
ResLoader.instance.loadRemote<ImageAsset>(this.url, opt, onComplete);
     */
...
await ResLoader.instance.loadBundle(serverUrl,md5);
     */
     ...
     * @param onComplete    加载完成回调
     * @example
ResLoader.instance.load("spine_path", sp.SkeletonData, (err: Error | null, sd: sp.SkeletonData) => {
...
ResLoader.instance.loadDir("game", onProgressCallback, onCompleteCallback);
     */
