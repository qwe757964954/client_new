...
export class SpineAniManager extends BaseControll {
	...
	/** 播放动画 */
	private startPlayAni(param: inf_SpineAniCreate) {
	...
	/** 停止动画 */
	private stopPlayAni( param: inf_SpineAniCreate) {
		if (!param || !param.resConf || !param.aniName) {
			return;
		};
	...
	public setSpineAni(aniNode: Node, resData, trackIndex: number, name: string, loop: boolean = false, premultipliedAlpha: boolean = false, skin: string = null, pos: Vec3 = null, startCallFunc: Function = null, endCallFunc: Function = null, oneLoopEndCallFunc: Function = null, processCallFunc: Function = null, frameNum: number = null,aniKey: string = ""): Node {
		...
		let node: Node = ImgUtil.create_2DNode(key);
	...
	private setAniData(node: Node, resData, trackIndex: number, name: string, loop: boolean, premultipliedAlpha: boolean, skin: string = null, startCallFunc: Function = null, endCallFunc: Function = null, oneLoopEndCallFunc: Function = null, processCallFunc: Function = null, frameNum: number = null) {
		let filePathName = ObjectUtil.stringSplitFileName(resData.path);
