...
export const TextConfig = {
    ...
    Speed_Words_Tip: "是否想要通过背单词加速？",
    Speed_Words_Tip1: "（每次建造可用1次单词加速，每次背10个单词，每个单词加速20秒）",
    Speed_Words_Tip2: "（每次升级可用1次单词加速，每次背10个单词，每个单词加速20秒）",
    Speed_Words_Tip3: "（每次制作可用1次单词加速，每次背10个单词，每个单词加速20秒）",
    Speed_Words_Tip4: "（每次扩张可用1次单词加速，每次背10个单词，每个单词加速20秒）",
    Speed_Words_Exit_Tip: "是否退出单词加速？",
    Speed_Words_Exit_Tip1: "（中途退出后，本次建造不能再用单词加速哦）",
    Speed_Words_Exit_Tip2: "（中途退出后，本次升级不能再用单词加速哦）",
