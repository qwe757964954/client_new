...
export const InterfacePath = {
    ...
    /***********************************************复习规划 end*********************************************/
    /***********************************************单词本 start*********************************************/
    c2sWordbookErrorbook: "3209", //单词本-错题本收藏本
    c2sWordbookCorrectWord: "3210", //单词本-收藏单词
    c2sWordbookWordSubmit: "3211", //单词本-单词提交
    c2sWordbookWordDetail: "3212", //单词本-单词详情
    /***********************************************单词本 end*********************************************/
    ...
    /***********************************************排行榜start*********************************************/
    Classification_UserVocabularyRank: "1500", //用户单词量排行榜
    /***********************************************排行榜 end*********************************************/
